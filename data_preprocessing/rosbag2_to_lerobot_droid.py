...
Examples:
  ...
  python3 rosbag2_to_lerobot_droid.py \
    ...
    --joint-topic /joint_states \
    --gripper-name robotiq_85_left_knuckle_joint \
    --fps 20 --compressed --prompt "sort trash by category"
"""
...
def to_rgb_from_compressed_msg(msg) -> np.ndarray:
    ...
    Decodes JPEG bytes using OpenCV (BGR->RGB).
    """
    # Ref logic based on your decode_compressed_image_file.py. :contentReference[oaicite:2]{index=2}
