...
DATASET_ID = "aaquibtabrez/lerobot_gen3_green_container"   # TODO: replace this
...
plot_joint_trajectories_per_joint(episode_trajs, max_eps=151, save_dir="plots", show=False)
print("Done.")
